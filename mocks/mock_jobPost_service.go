...
func (_m *MockJobPostServiceInterface) GetJobPosts(jobPostType string) (*[]models.JobPost, error) {
...
func (_mr *MockJobPostServiceInterfaceMockRecorder) GetJobPosts(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "GetJobPosts", reflect.TypeOf((*MockJobPostServiceInterface)(nil).GetJobPosts), arg0)
}
